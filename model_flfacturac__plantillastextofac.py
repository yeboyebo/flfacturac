...
# @class_declaration flfacturac_plantillastextofac #
class flfacturac_plantillastextofac(interna_plantillastextofac, helpers.MixinConAcciones):
    pass
...
class plantillastextofac(flfacturac_plantillastextofac, helpers.MixinConAcciones):
    pass
