...
# @class_declaration flfacturac_lineasalbaranesprov #
class flfacturac_lineasalbaranesprov(interna_lineasalbaranesprov, helpers.MixinConAcciones):
    pass
...
class lineasalbaranesprov(flfacturac_lineasalbaranesprov, helpers.MixinConAcciones):
    pass
